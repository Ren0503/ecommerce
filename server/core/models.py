...
from users.models import User, ImageUpload
...
class ProductImage(models.Model):
    ...
    image = models.ForeignKey(
        ImageUpload, related_name="image_product", on_delete=models.CASCADE)
...
class Cart(models.Model):
    ...
    user = models.ForeignKey(
        User, related_name="user_carts", on_delete=models.CASCADE)
